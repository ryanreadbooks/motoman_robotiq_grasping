...
def convert_pose(pose, from_frame, to_frame):
    ...
    :param from_frame: str -> 原始的坐标系
    :param to_frame: str -> 希望转到的坐标系
    """
...
def current_robot_pose(reference_frame, base_frame):
    ...
    :param reference_frame: str -> 参考系的frame_id
...
def publish_stamped_transform(stamped_transform, seconds=1):
    ...
    :param stamped_transform: geometry_msgs/TransformStamped -> 待发布的变换
    :param seconds: 持续发布变换多少时长
    """
